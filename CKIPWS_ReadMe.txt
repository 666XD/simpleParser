...
# 可以配合 ConvertZ8.02 轉換成 big5 (本系統並不包含 ConvertZ 軟體)
...
# 如果不想用 ConvertZ8.02, 可以試用 Windows PowerShell 來處理
    開始 --> 執行 --> powershell [enter]
    gc -encoding unicode test\sample_utf16le.tag | sc -encoding utf8 .\sample_utf8.tag
    gc -encoding unicode test\sample_utf16le.tag | sc -encoding string .\sample_big5.tag
